...
def calc_com(run_start_uid, roi=None):
    ...
    elif (scan_doc['fast_axis']['motor_name'] == 'nano_stage_x'):
        (com_x, com_y)  = center_of_mass(d)  # for coarse-stage flying x scans
    else:
...
# th = np.linspace(-85, 85, 5)
# theta_list = np.concatenate((th, np.array([180]), th+185, th+362.5, th+547.5))
theta_list = np.concatenate((np.linspace(0, 84, 8),
                             np.linspace(84-6, -84+6, 14),
                             np.linspace(-84, -12, 7)))
theta_to_start = 12
...
# xstart, xstop, xnum, ystart, ystop, ynum, dwell = -29920-100, -29920+100, 201, 9920, 9920+100, 101, 0.100
# xstart, xstop, xnum, ystart, ystop, ynum, dwell = -30065, -29665, 401, 1575, 1675, 101, 0.05
xstart, xstop, xnum, ystart, ystop, ynum, dwell = -30120-15, -29720-15, 401, 10230-50, 10230+50, 101, 0.05
...
try:
    ...
    for theta in theta_list:
        ...
        xstart, xstop, ystart, ystop = calc_com(run_uid, roi=(737, 757))  # This is the ROI for Ni
